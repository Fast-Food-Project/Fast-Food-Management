...
const PaginationUI: React.FC<pagination> = ({ paginationUI }) => {
  ...
  return (
    <div className="flex flex-row bg-transparent w-full justify-between items-center">
      {totalPages > 0 ? (
        <div className="flex items-center justify-start text-text-dark-400 text-opacity-40 dark:text-dark-400 dark:text-opacity-80 text-[14px] font-normal">
              ...
              if (page === "...") {
                return (
                  <PaginationItem key={`ellipsis`}>
                    <span className="text-light-550  text-[14px] font-normal">
                      ...
                    </span>
                  </PaginationItem>
                );
                ...
                return (
                  <PaginationItem key={page}>
                    <PaginationLink
                      ...
                      className={`${
                        currentPage === page
                          ? "active bg-active-background   rounded-full items-center justify-center h-fit w-fit"
                          : "items-center justify-center h-fit w-fit"
                      }`}
                    >
                      <p className="text-text-dark-400 dark:text-dark-450 text-[14px] font-normal px-[6px] py-0">
                        {page}
                      </p>
                    </PaginationLink>
                  </PaginationItem>
